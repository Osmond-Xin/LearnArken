...
<!-- generated by tools/gen_benchmark_tables.py from eval/results/day4-ablation.json — do not hand-edit -->
...
| hybrid (RRF) | 0.93 | **1.00** | 0.85 | 0.88 | 0.00 | 4 ms |
| hybrid + rerank | **0.99** | 0.99 | 0.85 | 0.88 | 0.00 | 124 ms |

Per-category Recall@5 (answerable queries only; cells with n<3 are indicative):

| Mode | applicability | cross-reference | descriptive | fault-isolation | identifier | identifier-perturbation | no-answer | paraphrase | procedural | warning |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
