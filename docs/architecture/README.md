...
> **AI-drafted**（Claude，实现方助手），基于 Day 1–6 已合并/在途代码、docs/specs、
> docs/discussions、docs/reviews 与 docs/local-services.md 蒸馏，**待 Yi Xin 审阅**。
> 快照日期：2026-07-17（Day 6 实现完成、待提交；Day 5 已合并打标 v0.5.0）。
...
| [03-config-and-services.md](03-config-and-services.md) | 配置全景图：工程工具链 + 本地 docker 服务（Vespa/Neo4j）+ MiniMax API（Day 5 起为 chat 供应商）|
| [04-tech-selection.md](04-tech-selection.md) | 选型说明：每项技术选择的候选、决定、理由与决策出处 |
| [05-api-and-demo.md](05-api-and-demo.md) | Day 6 服务化：FastAPI + Streamlit 哑客户端、SSE 流式带召回、上传事务化、demo 安全边界 |

## 维护规则

- 每个"重架构日"（Day 4/5/6/8）收口时更新对应章节；
