...
| [package-b/](package-b/README.md) | **Invalid** package carrying violation classes VIO-1..VIO-8 exactly once each, plus one clean control module. The violation manifest in its README is the Day 2 validator's exam (INV-3). |
